...
<!--/应该放在body下的div-->
                    ...
                    <div class="col-lg-2 col-lg-offset-8">
	                	<div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <h3> PM10 </h3>
								<div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%" id="S2">
                                        100%
                                    </div>
                                </div>
                                <h3> S4 </h3>
								<div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%" id="S3">
                                        100%
                                    </div>
                                </div>
                            </div>
    ...
    var point = new BMap.Point(113.3446,23.1513);
    map.centerAndZoom(point, 15);             // 初始化地图，设置中心点坐标和地图级别
    map.enableScrollWheelZoom(); // 允许滚轮缩放
  
    var points2 =[
    {"lng":113.344619,"lat":23.151353,"count":50}
    ];
    var points =[
    <?php
...
?>;
		var loop1=self.setInterval(getData,1500);
		...
		function getData(){
  		...
  		function restart(){
	  		loop1=self.setInterval(getData,1500);
  		}
</script>
<script type="text/javascript">
